...
module.exports = class Stream {
  ...
  showDumps() {
    ...
    console.log(`> BOT | \x1b[1m[STREAM]\x1b[0m Dumps :`)
  ...
  async getOther() {
    for (let i = 0; i < this.total/100; i++) {
      await new Promise((resolve, reject) => {
        ...
        readline.clearLine();
        readline.cursorTo(0);
        process.stdout.write(`> BOT | \x1b[1m[STREAM]\x1b[0m Dumping followers list... ${ Math.round((i)*100/(this.total/100))}% | ${this.pagination.cursor?this.pagination.cursor:"finished"}\r`);
